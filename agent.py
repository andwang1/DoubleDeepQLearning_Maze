...
class DQN:
    ...
    def create_sample_test_steps(self):
        ...
        self.test_current_state_actions_gaussian = np.empty((self.gauss_sample_size, 4))
        self.test_next_state_actions_gaussian = np.empty((self.batch_size * self.gauss_sample_size, 4))
