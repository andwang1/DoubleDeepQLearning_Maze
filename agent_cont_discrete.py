...
class DQN:
    ...
    def __init__(self, step_length, batch_size, replay_buffer_size, angles_between_actions=2):
        ...
        # FOR GREEDY NEED 8 per state
        # FOR EXPLORATION NEED FULL SAMPLE, exploration only need current state
        # Next state greedy will always be
    ...
    def return_next_state_q_greedy_target(self, transitions: torch.tensor): #TODO 1
        next_states = transitions[2] # tensor
